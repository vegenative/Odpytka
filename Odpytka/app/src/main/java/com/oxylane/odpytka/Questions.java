...
public class Questions {
    ...
    public Questions(){
        ...
        answersAll.add("Obchodzie Bezpieczeństwa Sektora wykonujemy codziennie w narzędziu explotool.pl\n" +
                ...
                "-Zabezpieczone broszki.\n" +
                "-Kółka od gondol są sprawne i schowane pod nogę.\n" +
                "-Ławki są sprawne i ustawione równo.\n" +
                "-Przy komputerach oraz zagrodach działowych panuje porządek (żaden produkt nie dotyka komputerów i monitorów, znajduje się wokół nich przestrzeń umożliwiająca dobrą wentylację).\n" +
        ...
        answersAll.add("ŁĄCZNIK STREFY: Pracownik Decathlon lub klient, który jako pierwsza dociera do drzwi ewakuacyjnych podczas Alarmu II Stopnia. Przewodnik Strefy może również wyznaczyć do tej roli klienta lub konkretnego pracownika.\n" +
                "\n" +
                "ALARM I STOPNIA (syrena)\n" +
                "osoba, która jako pierwsza znajdzie się przy drzwiach, lub zostanie wyznaczona przez przewodnika strefy \n" +
                "ALARM II STOPNIA (komunikat głosowy)\n" +
                "a) Otwiera drzwi na oścież.\n" +
                "b) Sprawdza drożność drogi ewakuacyjnej.\n" +
                "c) Kieruje ewakuowanych Klientów i Pracowników do drzwi stojąc w ich obrębie.\n" +
    ...
    public ArrayList<String> getList(int x){
        ...
        ArrayList<String> newLstQuestion = questionsAll;
        ArrayList<String> newLstAnswer = answersAll;
