...
public class QuestionsManager {
    private ArrayList<String> questionsManager = new ArrayList<>();
    private ArrayList<String> answersManager = new ArrayList<>();
    ...
    public ArrayList<String> getList(int x){
        ...
        ArrayList<String> outputManager = new ArrayList<>();
        Random rn = new Random();
        int index;
        for (int i = 0; i < x; i++) {
            index = rn.nextInt(newLstQuestion.size());
            outputManager.add(newLstQuestion.get(index));
            outputManager.add(newLstAnswer.get(index));
